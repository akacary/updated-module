import { FormApplicationV2 } from "foundry/app";
// GET REQUIRED LIBRARIES

// GET MODULE CORE
import { MODULE } from '../_module.mjs';

export class PreviewDialog extends FormApplicationV2 {
	constructor(data) {
		super();
    ...
    getBasePosition() {
        const position = super.getBasePosition();
        position.width = this.options.width ?? 600;
        position.height = this.options.height ?? "auto";
        return position;
    }
}
